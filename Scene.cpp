...
Scene::Scene(){
    wall.push_back(Wall(Point(0,0,20),Point(150,0,80),Hitbox(Rectangle(Point(0,0,20),Point(150,0,80))),1500));
    wall.push_back(Wall(Point(150,0,80),Point(900,0,240),Hitbox(Rectangle(Point(),Point())),1500));
    wall.push_back(Wall(Point(900,0,240),Point(1600,0,60),Hitbox(Rectangle(Point(),Point())),1500));
